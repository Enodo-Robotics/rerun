...
### A short taste
```py
import rerun as rr  # pip install --pre --no-index -f https://github.com/enodo_motion/rerun/releases/download/prerelease --upgrade rerun-sdk
...
* [**Python**](https://www.rerun.io/docs/getting-started/quick-start/python): `pip install --pre --no-index -f https://github.com/enodo_motion/rerun/releases/download/prerelease --upgrade rerun-sdk` or on [`conda`](https://github.com/conda-forge/rerun-sdk-feedstock)
...
It can be installed with `pip install --pre --no-index -f https://github.com/enodo_motion/rerun/releases/download/prerelease --upgrade rerun-sdk` or with `cargo install rerun-cli --locked --features nasm` (see note below).
