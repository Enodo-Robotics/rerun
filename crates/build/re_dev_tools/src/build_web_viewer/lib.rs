...
pub fn build(
...

    {
        ...
        //
        // --growable-table: without this, wasm-ld emits table[0] with max==min, which
        //   prevents the function table from growing and breaks the viewer at runtime.
        ...
        // CARGO_ENCODED_RUSTFLAGS uses \x1f (unit separator), not spaces.
        cmd.env("CARGO_ENCODED_RUSTFLAGS", wasm_rustflags_parts.join("\x1f"));
